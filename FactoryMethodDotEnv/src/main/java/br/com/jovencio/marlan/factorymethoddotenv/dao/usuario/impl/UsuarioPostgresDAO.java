...
import br.com.jovencio.marlan.factorymethoddotenv.dao.conexoes.impl.PostgresConexao;
 ...
 * @author marlan
 */
public class UsuarioPostgresDAO extends PostgresConexao implements IUsuarioDAO {

	Logger log = LoggerFactory.getLogger( UsuarioPostgresDAO.class );
	...
	public void createTable() throws Exception {
		...
		sql.append( "     id integer primary key GENERATED BY DEFAULT AS IDENTITY, " );
...
//		}
//		if( usuario.getId() == null || Long.compare( usuario.getId(), 0L ) == 0 ) {
//			return null;
//		}
		return usuario;
	}
